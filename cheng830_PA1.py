...
def hack_bank(account_list):
    ...
    if (len(account_list) >= 2):
        ...
        if(account_list[0].balance > account_list[1].balance):
            max = account_list[0].balance
            min = account_list[1].balance
        else:
            max = account_list[1].balance
            min = account_list[0].balance

        for i in range(len(account_list)):
             if(account_list[i].balance >= max ):
                max = account_list[i].balance
                maxIndex = i
            
             if(account_list[i].balance <= min ):
                min = account_list[i].balance
                minIndex = i

     #   print('Max = ', maxIndex, 'min = ', minIndex)
        account_list[maxIndex].balance -= 1337
        account_list[minIndex].balance += 1337
